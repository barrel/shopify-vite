...
export const assetUrl = (fileName: string, versionNumbers: boolean): string => {
  if (!versionNumbers) {
...
export const viteEntryTag = (entryPaths: string[], tag: string, isFirstEntry = false): string =>
 ...
 */
export function resolveDevServerUrl (address: AddressInfo, config: ResolvedConfig): DevServerUrl {
